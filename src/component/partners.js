            ...
            <div style={{position: "relative",backgroundColor: "#f7bb3e"}} className={"partnerSection"}>
                ...
                <div className={"partnerContainer"}>
                    ...
                    <div style={{display:"flex",flexFlow:"column",justifyContent:"center"}}>
                        ...
                        <small>-10 % sur vos commandes avec le code <span style={{fontWeight:"bold"}}>STREAMON10</span><br/> pendant la durée de l'événement</small>
                    </div>
                    ...
                    <div style={{display:"flex",flexFlow:"column",justifyContent:"center"}}>
                        ...
                        <small>-10 % sur vos commandes avec le code <span style={{fontWeight:"bold"}}>Stream10</span><br/> pendant la durée de
                            l'événement</small>
                    </div>
