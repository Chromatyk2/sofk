        ...
        <>
            ...
            <div class={"donationBarMobile"}>
                {donation.filter(item => item.montant > montant).length > 0 ?
                        <>
                            <MarqueeText duration={10} direction={"right"} textSpacing={"8em"} className={"scrollTextCardInlinePlayer"}>
            ...
            {props.team.length > 0 &&
                ...
                <div>
                    ...
                    <div style={{
                        ...
                        <a href={"https://streamlabscharity.com/teams/@stream-on-for-kids-2025/stream-on-for-kids-2025?member=" + props.team.filter(item => item.user.display_name == streamer).user.id + "&l=fr-FR"}
                           target={"_blank"}
