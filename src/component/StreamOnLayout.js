            ...
            {streamToDisplay ?
                <>
                    ...
                    <a style={{position: "absolute", left: "0", right: "0", margin: "auto", bottom: "60px"}}
                       ...
                       href={"https://streamlabscharity.com/teams/@stream-on-for-kids-2024/stream-on-for-kids-2024?member="+charityTeam.find((person) => person.infos.display_name === streamToDisplay.toLowerCase()).infos.id+"&l=fr-FR"}>Faire
                        un Don</a>
                </>
                :
                <>
